...
def points_to_voxel(points,
    ...
    # print(voxelmap_shape)  #voxelmap_shape = [depth, width, height]
    voxelmap_shape = tuple(np.round(voxelmap_shape).astype(np.int32).tolist())
    if reverse_index:
        voxelmap_shape = voxelmap_shape[::-1]
        # print(voxelmap_shape)  #voxelmap_shape = [height, width, depth]
    ...
    # print("coor_to_voxelidx:", coor_to_voxelidx == -np.ones(shape=voxelmap_shape, dtype=np.int32))
