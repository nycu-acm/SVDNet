...
def restore(ckpt_path, model):
    ...
    # # original weight loading
    # model.load_state_dict(torch.load(ckpt_path))
    # print("Restoring parameters from {}".format(ckpt_path))
    
    ######   load pre-weight of feature extraction part ######
    if "voxelnet" in ckpt_path:
        for name, param in torch.load(ckpt_path).items():
            if "voxel" in name:
                param = param.data
    ...
    # if "voxelnet" in ckpt_path:
    #     for name, param in torch.load(ckpt_path).items():
    #         if "coefficient_pridict" in name:
    #             continue
    #         else:
    #             if "voxel" in name:
    #                 param = param.data
...
######################  close the gradient of feature extraction part ##########################
    # try:
    #     for name, child in model.named_children():
    #         if name == "voxel_feature_extractor" :
